export const Mission = () => {
    return (
        <section>
            <h2>Our mission</h2>
            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ut, nesciunt
                veniam. Excepturi itaque, voluptates fugiat perspiciatis quo saepe! Iste
                eaque porro eveniet error dicta, modi ipsum hic quis minima inventore.</p>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempora quaerat
                ...
                pariatur? Molestiae libero cum quidem.</p>
        </section>
    )
}